...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		//pegando referencia da janela, window é uma superclasse do stage, por isso o downCasting;
	...
	//informando o stage que criou a janela de dialogo;
		try {
			...
			controller.subscribeDataChangeListener(this);// ouvindo o evento - quando acionado ele executará o onDataChanged();

...
public class MainViewController implements Initializable {
	...
	public void onMenuItemDepartmentAction() {
		loadView("/gui/DepartmentList.fxml", (DepartmentListController controller) ->{
			//importante, expressão lambda chamando função; Foi parametrizada como parêmetro da função loadView;
			//mais prático e reutilizável; 
	...
	private synchronized <T> void loadView(String absoluteName, Consumer<T> initializinAction) {//tipo genérico;
		...
		T controller = loader.getController();// tipo genérico recebendo o controller;
